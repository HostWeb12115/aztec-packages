...
* **[CALLDATACOPY](#calldatacopy)**: Copy calldata to memory
    * Opcode `0x1F`
    ...
    ```
* **[SUCCESSCOPY](#successcopy)**: Get success status of latest call
    * Opcode `0x20`
    ```javascript
...
Get success status of latest call
...
| `inTag` | Type tag | Type tag to assign to the value |
...
- **SIDE_EFFECT_LIMIT_REACHED**: Exceeded maximum public data updates per transaction
- **MEMORY_ACCESS_OUT_OF_RANGE**: Memory offset operand exceeds addressable memory
...
- **INDEX_OUT_OF_RANGE**: Leaf index exceeds note hash tree size
- **MEMORY_ACCESS_OUT_OF_RANGE**: Memory offset operand exceeds addressable memory
...
- **SIDE_EFFECT_LIMIT_REACHED**: Exceeded maximum note hashes per transaction
- **MEMORY_ACCESS_OUT_OF_RANGE**: Memory offset operand exceeds addressable memory
...
- **SIDE_EFFECT_LIMIT_REACHED**: Exceeded maximum nullifiers per transaction
- **MEMORY_ACCESS_OUT_OF_RANGE**: Memory offset operand exceeds addressable memory
...
- **INDEX_OUT_OF_RANGE**: Leaf index exceeds L1-to-L2 message tree size
- **MEMORY_ACCESS_OUT_OF_RANGE**: Memory offset operand exceeds addressable memory
...
- **SIDE_EFFECT_LIMIT_REACHED**: Exceeded maximum logs per transaction
- **MEMORY_ACCESS_OUT_OF_RANGE**: Memory offset operand exceeds addressable memory
...
- **SIDE_EFFECT_LIMIT_REACHED**: Exceeded maximum L2-to-L1 messages per transaction
- **MEMORY_ACCESS_OUT_OF_RANGE**: Memory offset operand exceeds addressable memory
...
- **SIDE_EFFECT_LIMIT_REACHED**: Exceeded maximum unique contract class IDs per transaction
- **MEMORY_ACCESS_OUT_OF_RANGE**: Memory offset operand exceeds addressable memory
